...
const CampaignSettings = ({ payload, setPayload, imageLink, setImageLink, onConfigChange }) => {
    return (
        <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-200 space-y-6">
            <h2 className="text-2xl font-semibold text-gray-900">1. Configuración de Campaña</h2>
