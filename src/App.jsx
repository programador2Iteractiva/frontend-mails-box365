...
const DUMMY_CAMPAIGNS = [
    {
        ...
        template: 'text-image',
        body: 'Aprovecha nuestros descuentos de hasta el 50% en productos seleccionados.',
        imageUrl: 'https://via.placeholder.com/600x400.png/FFD700/000000?text=¡Oferta+de+Verano!',
        imageLink: '#',
